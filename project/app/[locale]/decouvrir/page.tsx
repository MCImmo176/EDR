...
export default function DecouvrirPage() {
  ...
  const allArticles = [
    ...insiderSecrets.map(item => ({ ...item, category: "secrets" })),
    ...cultureEvents.map(item => ({ ...item, category: "culture-monaco" })),
    ...sportsLoisirs.map(item => ({ ...item, category: "sport-loisirs" })),
    ...naturePaysages.map(item => ({ ...item, category: "nature-paysages" })),
    ...villagesArtVivre.map(item => ({ ...item, category: "villages-art-vivre" })),
    ...premiumExperiences.map(item => ({ ...item, category: "premium-experiences" }))
  ];
          ...
          <div className="w-full h-full flex flex-col justify-center">
            <div className="pl-[15%] md:pl-[10%] w-full max-w-[80%] md:max-w-[60%]">
              ...
              <motion.div 
                ...
                className="h-[2px] bg-[#BC9A6B] mt-8 mb-12"
              ></motion.div>
