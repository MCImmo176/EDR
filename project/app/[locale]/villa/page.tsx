          ...
          <div className="max-w-screen-xl mx-auto">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 1, ease: [0.22, 1, 0.36, 1], delay: 0.6 }}
                viewport={{ once: true }}
                className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto"
              >
                {[
                  {
                    src: "/images/villa/IMG_2359.jpg",
                  ...
                  },
                  {
                    ...
                    caption: "Service de conciergerie"
                  },
                  {
                    src: "/images/villa/IMG_2286.JPEG",
                    alt: "Atmosphère raffinée",
                    caption: "Atmosphère raffinée"
                  }
                ].map((image, index) => (
                  <div key={index} className="group relative overflow-hidden h-80">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      <div className="h-px w-10 bg-white mb-3 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                      <p className="font-light tracking-wide transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                        {image.caption}
                      </p>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="relative aspect-[4/3] overflow-hidden group">
                  ...
                  <div className="absolute bottom-8 left-8 right-8">
                    <h3 className="text-white text-xl font-light tracking-wide mb-3">Matériaux nobles</h3>
                    <p className="text-white/80 text-sm font-light">Des finitions impeccables avec des matériaux sélectionnés pour leur qualité exceptionnelle</p>
                  </div>
                </div>
                <div className="relative aspect-[4/3] overflow-hidden group">
                  <Image
                    src="/images/villa/IMG_2325.JPEG"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                  <div className="absolute bottom-8 left-8 right-8">
                    <h3 className="text-white text-xl font-light tracking-wide mb-3">Design épuré</h3>
                    <p className="text-white/80 text-sm font-light">Un intérieur contemporain où l'élégance se marie à la simplicité pour un luxe intemporel</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <motion.h2
                ...
                transition={{ duration: 1, ease: [0.22, 1, 0.36, 1], delay: 0.1 }}
                viewport={{ once: true }}
                className="text-3xl md:text-4xl font-display text-center max-w-4xl leading-tight mb-6 tracking-wider"
              >
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
                viewport={{ once: true }}
                className="h-[1px] w-24 bg-[#b7a66b] mx-auto my-8"
              />
            </div>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-8">
                {[
                  ...
                  >
                    <h3 className="text-lg font-display mb-3 text-[#343434]">{point.title}</h3>
